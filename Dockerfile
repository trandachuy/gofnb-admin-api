...
COPY /var/jenkins_home/workspace/gofnb-admin-api/GoFoodBeverage/*.sln .
COPY /var/jenkins_home/workspace/gofnb-admin-api/GoFoodBeverage/GoFoodBeverage.WebApi/*.*.csproj ./aspnetapp/
RUN dotnet restore
...
COPY /var/jenkins_home/workspace/gofnb-admin-api/GoFoodBeverage/GoFoodBeverage.WebApi/. ./aspnetapp/
